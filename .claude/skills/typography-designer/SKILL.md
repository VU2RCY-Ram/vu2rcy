...
description: "Typography system designer — selects font families, builds a type scale (H1-H6, body, small, caption), defines font weights/line-heights/letter-spacing, and checks accessibility (WCAG AA contrast, minimum sizes, line length) plus responsive scaling. Use when designing or reviewing typography for a UI: choosing fonts, setting heading/body sizes, or auditing text readability."
---
