...
import EquipmentsList from "../../../components/shack/vhf-uhf/EquipmentsList";
    ...
    <div className="px-5 sm:px-8 md:px-12 lg:px-16 xl:px-20 max-w-[75rem] mx-auto mb-10">
      ...
      <main className="max-w-screen">
        <div className="pt-20 container mx-auto p-4">
          <h1 className="landing-h1 text-center text-xl md:text-2xl lg:text-3xl xl:text-4xl">VHF/UHF</h1>
